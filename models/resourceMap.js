...
const ResourceMapSchema = new Mongoose.Schema({
  projectID: {
    // Reference to the Project model through ObjectID
    type: Mongoose.Schema.Types.ObjectId,
    ref: "Project",
  },
  resourceID: {
    // Reference to the User model through ObjectID
    type: Mongoose.Schema.Types.ObjectId,
    ref: "User",
  },
  expectedHours: {
    // Number of expected hours for the resource
    type: Number,
  },
  description: {
    // Description of the resource mapping
    type: String,
  },
  isClientBillable: {
    // Specifies whether the resource is client billable or not and from what date
